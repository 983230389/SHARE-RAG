...
if __name__ == "__main__":
    ...
    if sys.argv[1] == 'fetch':
        ...
        print(json.dumps(fetch_data(int(sys.argv[2]))))
    elif sys.argv[1] == 'testcase':
        # print(get_testcase(int(sys.argv[2]), int(sys.argv[3])))
        print(json.dumps(get_testcase(int(sys.argv[2]), int(sys.argv[3]))))
    else:
        # print(judge(int(sys.argv[2]), open(sys.argv[3]).read()))
        print(json.dumps(judge(int(sys.argv[2]), open(sys.argv[3]).read())))
